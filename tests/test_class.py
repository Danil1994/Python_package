...
drivers = [Driver(abbr='DRR',
                  ...
                  start_time=datetime.strptime('2018-05-24_12:11:24.067', time_format),
                  end_time=datetime.strptime('2018-05-24_12:14:12.054', time_format),
...
class TestFunc(unittest.TestCase):
    ...
    @patch('src.main.main_class._calculate_laps_time', return_value='0:02:47.987')
    ...
    @patch('src.main.main_class._add_start_end_time', return_value=[Driver(abbr='DRR',
                                                                           ...
                                                                           start_time=datetime.strptime(
                                                                               '2018-05-24_12:11:24.067', time_format),
                                                                           end_time=datetime.strptime(
                                                                               '2018-05-24_12:14:12.054', time_format),
                                                                           lap_time=None)])
    ...
    def test_create(self, mock_add_lap_time, mock_add_start_end_time, mock_init_abb_name_car, mock_abbr_name_car,
                    mock_abbr_and_time,
                    mock_read_file):
        mock_read_file.side_effect = ['DRR2018-05-24_12:11:24.067', 'DRR2018-05-24_12:14:12.054',
                                      'DRR_Daniel Ricciardo_RED BULL RACING TAG HEUER']
        mock_abbr_and_time.side_effect = [{'DRR': ['2018-05-24_12:11:24.067']}, {'SVF': ['2018-05-24_12:04:03.332']}]
    ...
    def test_build_position_list(self):
        self.assertEqual(_build_position_list(drivers),
                         ['1.  Daniel Ricciardo   | RED BULL RACING TAG HEUER  | 0:02:47.987',
    ...
    def test_sorting(self):
        self.assertEqual(sorting_order_by(drivers, desc=False),
                         [Driver(abbr='SVF',
                                 name='Sebastian Vettel',
                                 car='FERRARI',
                                 start_time=datetime.strptime('2018-05-24_12:02:58.917', time_format),
                          ...
                          Driver(abbr='LHM',
                                 name='Lewis Hamilton',
                                 car='MERCEDES',
                                 start_time=datetime.strptime('2018-5-24_12:11:32.585', time_format),
                                 end_time=datetime.strptime('2018-05-24_12:18:20.125', time_format),
                                 lap_time='0:06:47.540')])

    def test_sorting_desc(self):
        self.assertEqual(sorting_order_by(drivers, desc=True),
                         [Driver(abbr='LHM',
                                 name='Lewis Hamilton',
                                 car='MERCEDES',
                                 start_time=datetime.strptime('2018-5-24_12:11:32.585', time_format),
